# Contributing to container-socket-proxy
...
1. Check the [issue tracker](https://gitlab.com/majramos/container-socket-proxy/-/work_items) to see if the bug has already been reported.
...
1. Check the [issue tracker](https://gitlab.com/majramos/container-socket-proxy/-/work_items) for similar suggestions.
...
2. Clone your fork locally:
   ```bash
   git clone https://gitlab.com/<YOUR_USERNAME>/container-socket-proxy.git
   cd container-socket-proxy
   ```
...
git clone https://gitlab.com/majramos/container-socket-proxy.git
cd container-socket-proxy
